...
#include "webpage.h"
const char* ssid = "PulsarPetRobot";
const char* password = "UNIT123456";
...
void mostrarPantallaWiFi() {
  ...
  u8g2.drawStr(10, 12, "PERRITO ROBOT");

  u8g2.drawStr(2, 28, "WiFi:");
  u8g2.drawStr(25, 28, ssid);

  u8g2.drawStr(10, 42, "IP:");
  u8g2.drawStr(35, 42, WiFi.softAPIP().toString().c_str());

  u8g2.drawStr(10, 58, "Esperando conexion...");
...
void loop() {
  ...
  clienteConectado = WiFi.softAPgetStationNum() > 0;
  // ── 1. SERIAL ────────────────────────────────────────────────
